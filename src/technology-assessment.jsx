...
const TechAssessment = () => {
  ...
  // Calculate TIS for all datasets
  ...
  // Get all unique technology names across datasets
  ...
  const styles = {
    ...
    // New styles for dataset comparison
    comparisonHeader: {
      display: "flex",
      justifyContent: "space-between",
      alignItems: "flex-start",
    ...
    comparisonTh: {
      ...
      padding: "12px 8px",
      fontWeight: "700",
      borderBottom: `2px solid ${qmicColors.primary}`,
      backgroundColor: qmicColors.lightBg,
      color: qmicColors.textDark,
      position: "sticky",
      top: 0,
          ...
          <div style={styles.header}>
            <div>
              ...
              <p style={styles.subtitle}>
                Comparison between different Technologies from various LLMs
              </p>
            </div>
      ...
      <div style={styles.contentWrapper}>
        ...
        <div style={styles.navTabs}>
          {[
            ...
            { id: "comparison", label: "Dataset Comparison", icon: BarChart3 },
        ...
        {activeView === "comparison" && (
          <div style={styles.card}>
            <div style={styles.comparisonHeader}>
              <div>
                <h2 style={styles.sectionTitle}>Dataset Comparison Analysis</h2>
            ...
            <div style={styles.datasetLegend}>
              {Object.entries(dataSources).map(([key, source]) => {
                ...
                return (
                  ...
                  >
                    <Database size={14} />
                    {source.name} ({source.count} techs)
                  </div>
                );
              })}
            </div>
            ...
            <div style={styles.tableContainer}>
              <table style={styles.comparisonTable}>
                <thead>
                  <tr>
                    <th style={styles.comparisonTh}>Technology</th>
                    <th style={styles.comparisonTh}>Category</th>
                    {Object.entries(dataSources).map(([key, source]) => {
                      return (
                        <th
                          key={key}
                    ...
                    <th style={{ ...styles.comparisonTh, textAlign: "center" }}>
                      Avg TIS
                    </th>
                    <th style={{ ...styles.comparisonTh, textAlign: "center" }}>
                      Consistency
                ...
                <tbody>
                  {getAllTechnologyNames().map((techName) => {
                    ...
                    return (
                      <tr key={techName} style={styles.tr}>
                        <td
                          style={{ ...styles.comparisonTd, fontWeight: "600" }}
                        >
                          {techName}
                        </td>
                        ...
                        {Object.entries(dataSources).map(([key]) => {
                          ...
                          return (
                            ...
                            >
                              <div>
                                <span
                                  style={{ ...styles.badgeTis, ...tisColor }}
                                >
                                  {result.tis}
                                </span>
                              </div>
            ...
            <div style={styles.formulaBox}>
              <h3 style={styles.formulaTitle}>
                Tech Impact Score (TIS) Formula Applied Uniformly:
              </h3>
              ...
              <p style={styles.formulaNote}>
                Consistency shows standard deviation of TIS scores across
                datasets. Lower values indicate higher agreement between AI
                assistants.
              </p>
            </div>
          </div>
                ...
                <table className="min-w-full border-collapse border border-gray-300 text-sm text-gray-800">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-3">
                        High relevance (Smart City / Robotics / Sustainability)
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-3 font-medium">
