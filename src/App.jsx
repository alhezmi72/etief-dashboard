...
import TechExpDashboard from "./technology-exploration";
import TechAssessment from "./technology-assessment";
      ...
      {currentPage === "exploration" && (
        <div className="p-8">
          <div className="max-w-7xl mx-auto mb-8">
            ...
            >
              <ArrowLeft size={20} /> Back to Framework Overview
            </button>
          </div>
          <div className="text-center p-6 bg-white rounded-lg shadow-md max-w-8xl mx-auto">
            <TechExpDashboard />
          </div>
        </div>
      )}
