...
const TechRadarView = ({ filteredTech, calculateTIS, categoryList }) => {
  ...
  const zoomIn    = useCallback(() => setZoom(z => clamp(Math.round((z + ZOOM_STEP) * 100) / 100, MIN_ZOOM, MAX_ZOOM)), []);
  const zoomOut   = useCallback(() => setZoom(z => clamp(Math.round((z - ZOOM_STEP) * 100) / 100, MIN_ZOOM, MAX_ZOOM)), []);
    ...
    <div ref={containerRef} style={{ position: "relative", userSelect: "none" }} onMouseMove={handleMouseMove}>
      ...
      >
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              fontSize: 16, fontWeight: 700, color: zoom >= MAX_ZOOM ? "#cbd5e1" : "#334155",
          ...
          <button
            ...
            style={{
              ...
              fontSize: 16, fontWeight: 700, color: zoom <= MIN_ZOOM ? "#cbd5e1" : "#334155",
              borderBottom: "1px solid #e2e8f0",
            }}
          >−</button>
          <button
            ...
            style={{
              ...
              cursor: "pointer", fontSize: 10, fontWeight: 600, color: "#334155",
            }}
        ...
        <svg
          ...
          width="100%"
          style={{ display: "block", cursor: zoom > 1 ? (isDragging ? "grabbing" : "grab") : "default", touchAction: "none" }}
